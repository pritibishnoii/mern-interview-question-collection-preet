...
- [What is Node.js runtime?](#what-is-nodejs-runtime)
- [What is difference between Node.js and JavaScript?](#what-is-difference-between-nodejs-and-javascript)
- [How does Node.js run JavaScript outside the browser?](#how-does-nodejs-run-javascript-outside-the-browser)
- [Node.js single-threaded?](#nodejs-single-threaded)
- [Node.js advantages and disadvantages?](#nodejs-advantages-and-disadvantages)
- [Node.js Applications?](#nodejs-applications)
- [What is V8 Engine](#what-is-v8-engine)
- [What is JIT compilation](#what-is-jit-compilation)
- [Stack Vs Heap Memory Management](#stack-vs-heap-memory-management)
### Node.js Modules
 
- [What is Built-in modules?](#what-is-built-in-modules)
- [User-defined / Local modules](#user-defined-local-modules)
- [node_modules](#node_modules)
- [What is npm?](#what-is-npm)
- [What is npx?](#what-is-npx)
- [What is package.json?](#what-is-packagejson)
- [What is npm ci command?](#what-is-npm-ci-command)
- [What is npm scripts?](#what-is-npm-scripts)
- [What is Semantic Versioning?](#what-is-semantic-versioning)
- [What is Caret (^) Vs Tilde (~)](#what-is-caret-vs-tilde)
- [What is Dependencies vs devDependencies?](#what-is-dependencies-vs-devdependencies)
- [What is CommonJS?](#what-is-commonjs)
- [What is ES Modules?](#what-is-es-modules)
- [How require() works?](#how-require-works)
- [What is module.exports?](#what-is-moduleexports)
- [exports vs module.exports?](#exports-vs-moduleexports)
- [What is Node.js module caching?](#what-is-nodejs-module-caching)
- [What is Circular Dependency](#what-is-circular-dependency)
### http & Core Modules
 
- [HTTP kya hai?](#http-kya-hai)
- [What is HTTP request Object?](#what-is-http-request-object)
- [What is HTTP response Object?](#what-is-http-response-object)
- [fs module](#fs-module)
...
- [buffer module (Binary Data)](#buffer-module-binary-data)
### Express.js
 
- [What is Express js](#what-is-express-js)
- [How to read Request body in express?](#how-to-read-request-body-in-express)
- [Route parameters?](#route-parameters)
- [Query parameters?](#query-parameters)
- [req.params vs req.query vs req.body](#reqparams-vs-reqquery-vs-reqbody)
...
- [What is next() in Express?](#what-is-next-in-express)
- [Router-level middleware?](#router-level-middleware)
- [Error-handling middleware?](#error-handling-middleware)
- [What is express.urlencoded()](#what-is-expressurlencoded)
- [What is Controller?](#what-is-controller)
- [What is Router kya hota hai?](#what-is-router-kya-hota-hai)
### REST & Auth
 
- [What is REST API](#what-is-rest-api)
- [REST ke principles?](#rest-ke-principles)
- [Authentication & Authorization](#authentication-authorization)
- [What is JWT kya hai?](#what-is-jwt-kya-hai)
- [Access token vs Refresh token?](#access-token-vs-refresh-token)
- [Where to Store JWT Token?](#where-to-store-jwt-token)
- [What is HTTP-only cookie?](#what-is-http-only-cookie)
- [What is CORS kya hai?](#what-is-cors-kya-hai)
- [What is XSS?](#what-is-xss)
- [What is CSRF?](#what-is-csrf)
- [What is HTTP vs HTTPS?](#what-is-http-vs-https)
### Process, Errors & Security
 
- [What is Node.js process?](#what-is-nodejs-process)
- [What is Password hashing?](#what-is-password-hashing)
- [What is bcrypt?](#what-is-bcrypt)
- [What is Salt?](#what-is-salt)
- [What are types of Errors in Node.js?](#what-are-types-of-errors-in-nodejs)
- [Operational vs programmer errors?](#operational-vs-programmer-errors)
- [How do you handle errors in express](#how-do-you-handle-errors-in-express)
- [Global error handler?](#global-error-handler)
- [AppError class](#apperror-class)
- [asyncHandler.js](#asynchandlerjs)
...
- [uncaughtException vs unhandledRejection?](#uncaughtexception-vs-unhandledrejection)
- [What should you do when Process crashes?](#what-should-you-do-when-process-crashes)
- [What is Graceful shutdown?](#what-is-graceful-shutdown)
- [SIGTERM vs SIGINT](#sigterm-vs-sigint)
### Database & Node.js
 
- [How Node.js communicates with MongoDB?](#how-nodejs-communicates-with-mongodb)
- [CRUD in Node.js](#crud-in-nodejs)
- [What is Mongoose kya hai?](#what-is-mongoose-kya-hai)
- [What is Mongoose schema?](#what-is-mongoose-schema)
- [What is Model?](#what-is-model)
- [What is populate() in Mongoose?](#what-is-populate-in-mongoose)
- [What is MongoDB indexing?](#what-is-mongodb-indexing)
- [find() vs findOne()](#find-vs-findone)
- [findById()](#findbyid)
- [insertOne() vs insertMany() in MongoDB?](#insertone-vs-insertmany-in-mongodb)
- [What is Model.create() vs insertMany() in mongoose?](#what-is-modelcreate-vs-insertmany-in-mongoose)
- [Model.updateOne() vs Model.updateMany()](#modelupdateone-vs-modelupdatemany)
- [Model.findByIdAndUpdate() VS Model.findOneAndUpdate()](#modelfindbyidandupdate-vs-modelfindoneandupdate)
- [Model.deleteOne() VS Model.deleteMany()](#modeldeleteone-vs-modeldeletemany)
- [Model.findByIdAndDelete() VS Model.findOneAndDelete()](#modelfindbyidanddelete-vs-modelfindoneanddelete)
- [What is Projection?](#what-is-projection)
- [What is Aggregation in MongoDB](#what-is-aggregation-in-mongodb)
- [$lookup in mongodb](#lookup-in-mongodb)
- [What is Connection pooling?](#what-is-connection-pooling)
- [What does Database connection pool do?](#what-does-database-connection-pool-do)
- [What is Transaction?](#what-is-transaction)
- [What is Helmet?](#what-is-helmet)
- [What is sharding?](#what-is-sharding)
- [What is shard key?](#what-is-shard-key)
...
- [What is Redis kya hai?](#what-is-redis-kya-hai)
- [What is Cache invalidation?](#what-is-cache-invalidation)
- [What is TTL?](#what-is-ttl)
- [Why do we use Redis in Node.js?](#why-do-we-use-redis-in-nodejs)
- [Load Balancer](#load-balancer)
- [Rate Limiting](#rate-limiting)
- [What is Nginx + Node.js architecture?](#what-is-nginx-nodejs-architecture)
- [What is Reverse Proxy?](#what-is-reverse-proxy)
- [Redis vs MongoDB?](#redis-vs-mongodb)
- [What is Session storage using Redis?](#what-is-session-storage-using-redis)
